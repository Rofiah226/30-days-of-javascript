...
// 3
console.log(setOfNums.delete(8));
...
// 5
const stringElement = ["Tea", "Bread", "Butter"];
const setOfElements = new Set(stringElement);
...
for (const country of mapOfCountries) {
  const characters = country.length;
  console.log(characters);
  // const numOfChar = new Map(characters)
}
...
const a = [4, 5, 8, 9];
const b = [3, 4, 5, 7];
const unionAandB = [...a, ...b];

const setA = new Set(a);
const setB = new Set(b);
const setOfUnion = new Set(unionAandB);
console.log(setOfUnion);
...
const difference = a.filter((num) => !setB.has(num));
